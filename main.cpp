...
void saveResult(const string& filename, const vector<long long>& matrix, size_t n, double exec_time, int threads) {
...
int main(int argc, char* argv[]) {
    ...
    saveResult("result_c.txt", result, nA, duration, num_threads);
